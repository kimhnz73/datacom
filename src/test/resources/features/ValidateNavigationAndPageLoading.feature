...
# Also it validates the page loading
Feature: Validate all hyperlinks in the CHALLENGE - Spot the BUGS! page
    ...
    Scenario: Validate navigation to Spot The Bugs Challenge Page and page loading
        Then I expect page to contain text "CHALLENGE - Spot the BUGS!"

    Scenario: Validate Home link navigation back to the main page and page loading
        Then I expect page to contain text "Home"
        When I click Home link
        Then I expect page to contain text "Welcome!"

    Scenario: Validate Contact link navigation back to the main page loading
